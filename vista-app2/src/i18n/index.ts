...
const tr = {
  ...
  asthma_risk_mode: 'Astım riski modu',
  pollen_filter: 'Polen filtresi',
  dust_sensitivity: 'Toz hassasiyeti',
  ...
  history: 'Geçmiş',
  remaining: 'kalan',
  filter_healthy: 'Filtre sağlıklı · ~4 ay kaldı',
  pre_filter: 'Ön filtre',
  carbon: 'Karbon',
  filter_info: 'Filtre bilgisi',
  active_carbon: 'Aktif karbon',
  total_runtime: 'Toplam çalışma',
  hours: 'saat',
  order_filter: 'Filtre sipariş ver',

  // Dashboard demo
  show_alert: 'Uyarı durumunu göster',
...
const en: typeof tr = {
  ...
  asthma_risk_mode: 'Asthma risk mode',
  pollen_filter: 'Pollen filter',
  dust_sensitivity: 'Dust sensitivity',
  add_device: 'Add device',

  filter: 'Filter',
  history: 'History',
  remaining: 'remaining',
  filter_healthy: 'Filter healthy · ~4 months left',
...
const de: typeof tr = {
  ...
  asthma_risk_mode: 'Asthma-Risikomodus',
  pollen_filter: 'Pollenfilter',
  dust_sensitivity: 'Staubempfindlichkeit',
  add_device: 'Gerät hinzufügen',

  filter: 'Filter',
  history: 'Verlauf',
  remaining: 'übrig',
  filter_healthy: 'Filter gesund · ~4 Monate übrig',
  pre_filter: 'Vorfilter',
  carbon: 'Kohle',
  filter_info: 'Filterinfo',
  active_carbon: 'Aktivkohle',
  total_runtime: 'Gesamtlaufzeit',
  hours: 'Stunden',
  order_filter: 'Filter bestellen',

  show_alert: 'Warnzustand anzeigen',
